...
@Component({
  selector: 'app-montemesola-summer2022-et0-etc-trend',
  templateUrl: './montemesola-summer2022-et0-etc-trend.component.html',
  styleUrl: './montemesola-summer2022-et0-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaSummer2022Et0EtcTrendComponent implements OnInit
{
