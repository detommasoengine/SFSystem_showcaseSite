...
import dataMontemesolaAnno1Summer from '../../../../Models/Montemesola/dataArrayMontemesola2021Summer';
import { ChartModule } from 'primeng/chart';

@Component({
  selector: 'app-montemesola-summer2021-rainfall-fertigation-event',
  templateUrl: './montemesola-summer2021-rainfall-fertigation-event.component.html',
  styleUrl: './montemesola-summer2021-rainfall-fertigation-event.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaSummer2021RainfallFertigationEventComponent implements OnInit{
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
       ...
       const filteredData = dataMontemesolaAnno1Summer.filter(obj => obj !== null);
    ...
    this.data = {
      labels: dataMontemesolaAnno1Summer.map(obj => obj.DATA),
      datasets: [
