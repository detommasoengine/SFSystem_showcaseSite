...
@Component({
  selector: 'app-montemesola-summer2022-precipitation',
  templateUrl: './montemesola-summer2022-precipitation.component.html',
  styleUrl: './montemesola-summer2022-precipitation.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaSummer2022PrecipitationComponent implements OnInit{
...
//   // const dateLabels= filteredData.map(obj => obj.DATA);
      ...
      this.data = {
          labels: ['APRILE', 'MAGGIO', 'GIUGNO', 'LUGLIO', 'AGOSTO'],
          datasets: [

            {
                ...
                fill: true,
                tension: 0,
                data: [0.43, 1.93, 5.17, 5.11, 2.62]
            },
            {
                type: 'bar',
                label: 'Precipitazioni',
                backgroundColor: documentStyle.getPropertyValue('--orange-500'),
                data: [0.26, 0.81, 1.85, 0.57, 2.49],
                borderColor: 'black',
                borderWidth: 3
            },
