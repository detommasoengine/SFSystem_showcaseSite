...
@Component({
  selector: 'app-montemesola-winter2021-rainfall-fertigation-event',
  templateUrl: './montemesola-winter2021-rainfall-fertigation-event.component.html',
  styleUrl: './montemesola-winter2021-rainfall-fertigation-event.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaWinter2021RainfallFertigationEventComponent implements OnInit{
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
       ...
       const filteredData = dataMontemesolaAnno1Winter.filter(obj => obj !== null);
    ...
    this.data = {
      labels: dataMontemesolaAnno1Winter.map(obj => obj.DATA),
      datasets: [
