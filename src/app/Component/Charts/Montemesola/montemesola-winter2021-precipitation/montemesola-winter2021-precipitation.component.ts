...
@Component({
  selector: 'app-montemesola-winter2021-precipitation',
  templateUrl: './montemesola-winter2021-precipitation.component.html',
  styleUrl: './montemesola-winter2021-precipitation.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaWinter2021PrecipitationComponent implements OnInit{
      ...
      this.data = {
          ...
          datasets: [

            {
                ...
                fill: true,
                tension: 0,
                data: [0.42, 0.33, 0.62, 0.82, 0.84]
            },
            {
                type: 'bar',
                label: 'Precipitazioni',
                backgroundColor: documentStyle.getPropertyValue('--orange-500'),
                data: [1.01, 1.07, 6.27, 1.37, 0.99],
                borderColor: 'black',
                borderWidth: 3
            },
