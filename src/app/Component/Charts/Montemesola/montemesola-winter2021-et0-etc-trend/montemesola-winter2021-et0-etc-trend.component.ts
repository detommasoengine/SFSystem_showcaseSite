...
@Component({
  selector: 'app-montemesola-winter2021-et0-etc-trend',
  templateUrl: './montemesola-winter2021-et0-etc-trend.component.html',
  styleUrl: './montemesola-winter2021-et0-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaWinter2021Et0EtcTrendComponent implements OnInit
{
