...
@Component({
  selector: 'app-montemesola-summer2021-precipitation',
  templateUrl: './montemesola-summer2021-precipitation.component.html',
  styleUrl: './montemesola-summer2021-precipitation.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaSummer2021PrecipitationComponent implements OnInit{
