...
import dataMontemesolaAnno2Summer from '../../../../Models/Montemesola/dataArrayMontemesola2022Summer';
import { ChartModule } from 'primeng/chart';

@Component({
  selector: 'app-montemesola-summer2022-rainfall-fertigation-event',
  templateUrl: './montemesola-summer2022-rainfall-fertigation-event.component.html',
  styleUrls: ['./montemesola-summer2022-rainfall-fertigation-event.component.css'],
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaSummer2022RainfallFertigationEventComponent implements OnInit{
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
       ...
       const filteredData = dataMontemesolaAnno2Summer.filter(obj => obj !== null);
    ...
    this.data = {
      labels: dataMontemesolaAnno2Summer.map(obj => obj.DATA),
      datasets: [
