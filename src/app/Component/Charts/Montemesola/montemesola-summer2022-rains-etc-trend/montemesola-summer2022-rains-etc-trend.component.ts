...
@Component({
  selector: 'app-montemesola-summer2022-rains-etc-trend',
  templateUrl: './montemesola-summer2022-rains-etc-trend.component.html',
  styleUrl: './montemesola-summer2022-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaSummer2022RainsEtcTrendComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        ...
        // Filtra solo i dati con valori non null per Et0 ed Etc
          const filteredData = dataMontemesolaAnno2Summer.filter(obj => obj.Cultivar !== null);
