...
@Component({
  selector: 'app-montemesola-winter2022-rains-etc-trend',
  templateUrl: './montemesola-winter2022-rains-etc-trend.component.html',
  styleUrl: './montemesola-winter2022-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class MontemesolaWinter2022RainsEtcTrendComponent implements OnInit {
