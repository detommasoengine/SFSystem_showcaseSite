...
@Component({
  selector: 'app-grottaglie-winter2021-rains-etc-trend',
  templateUrl: './grottaglie-winter2021-rains-etc-trend.component.html',
  styleUrl: './grottaglie-winter2021-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieWinter2021RainsEtcTrendComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        ...
        // Filtra solo i dati con valori non null per Et0 ed Etc
          const filteredData = dataGrottaglieAnno1Winter.filter(obj => obj.Cultivar !== null);
