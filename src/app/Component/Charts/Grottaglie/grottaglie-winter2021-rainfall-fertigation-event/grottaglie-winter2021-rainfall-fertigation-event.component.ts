...
import dataGrottaglieAnno1Winter from '../../../../Models/Grottaglie copy/dataArrayGrottaglie2021Winter';
import { ChartModule } from 'primeng/chart';

@Component({
  selector: 'app-grottaglie-winterer2021-rainfall-fertigation-event',
  templateUrl: './grottaglie-winter2021-rainfall-fertigation-event.component.html',
  styleUrl: './grottaglie-winter2021-rainfall-fertigation-event.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieWinter2021RainfallFertigationEventComponent implements OnInit{
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
       ...
       const filteredData = dataGrottaglieAnno1Winter.filter(obj => obj !== null);
