...
import dataGrottaglieAnno2Winter from '../../../../Models/Grottaglie copy/ArrayObjectGrottaglie';
import { ChartModule } from 'primeng/chart';

@Component({
  selector: 'app-grottaglie-winter2022-rains-etc-trend',
  templateUrl: './grottaglie-winter2022-rains-etc-trend.component.html',
  styleUrl: './grottaglie-winter2022-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieWinter2022RainsEtcTrendComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        ...
        // Filtra solo i dati con valori non null per Et0 ed Etc
          const filteredData = dataGrottaglieAnno2Winter.filter(obj => obj.Cultivar !== null);
