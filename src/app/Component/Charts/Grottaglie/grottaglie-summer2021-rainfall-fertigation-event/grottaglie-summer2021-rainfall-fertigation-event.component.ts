...
@Component({
  selector: 'app-grottaglie-summer2021-rainfall-fertigation-event',
  templateUrl: './grottaglie-summer2021-rainfall-fertigation-event.component.html',
  styleUrl: './grottaglie-summer2021-rainfall-fertigation-event.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieSummer2021RainfallFertigationEventComponent implements OnInit{
