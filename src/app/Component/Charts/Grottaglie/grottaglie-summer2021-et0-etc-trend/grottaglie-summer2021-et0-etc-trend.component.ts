...
@Component({
  selector: 'app-grottaglie-summer2021-et0-etc-trend',
  templateUrl: './grottaglie-summer2021-et0-etc-trend.component.html',
  styleUrl: './grottaglie-summer2021-et0-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieSummer2021Et0EtcTrendComponent implements OnInit
{
