...
import dataGrottaglieAnno2Winter from '../../../../Models/Grottaglie copy/dataArrayGrottaglie2022Winter';
import { ChartModule } from 'primeng/chart';

@Component({
  selector: 'app-grottaglie-winterer2022-rainfall-fertigation-event',
  templateUrl: './grottaglie-winterer2022-rainfall-fertigation-event.component.html',
  styleUrl: './grottaglie-winterer2022-rainfall-fertigation-event.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieWinter2022RainfallFertigationEventComponent implements OnInit{
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
       ...
       const filteredData = dataGrottaglieAnno2Winter.filter(obj => obj !== null);
