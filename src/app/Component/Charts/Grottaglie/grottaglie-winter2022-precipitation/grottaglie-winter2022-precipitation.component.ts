...
@Component({
  selector: 'app-grottaglie-winter2022-precipitation',
  templateUrl: './grottaglie-winter2022-precipitation.component.html',
  styleUrl: './grottaglie-winter2022-precipitation.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieWinter2022PrecipitationComponent implements OnInit{
      ...
      this.data = {
          ...
          datasets: [

            {
                ...
                fill: true,
                tension: 0,
                data: [0.28, 0.28, 0.60, 1.02, 1.27]
            },
            {
                type: 'bar',
                label: 'Precipitazioni',
                backgroundColor: documentStyle.getPropertyValue('--orange-500'),
                data: [1.05, 3.20, 2.58, 3.26, 1.54],
                borderColor: 'black',
                borderWidth: 3
            },
