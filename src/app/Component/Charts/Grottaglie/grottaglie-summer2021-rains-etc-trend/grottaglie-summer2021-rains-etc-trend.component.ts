...
@Component({
  selector: 'app-grottaglie-summer2021-rains-etc-trend',
  templateUrl: './grottaglie-summer2021-rains-etc-trend.component.html',
  styleUrl: './grottaglie-summer2021-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieSummer2021RainsEtcTrendComponent implements OnInit {
