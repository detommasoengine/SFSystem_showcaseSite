...
import dataGrottaglieAnno2Summer from '../../../../Models/Grottaglie copy/dataArrayGrottaglie2022Summer';
import { ChartModule } from 'primeng/chart';

@Component({
  selector: 'app-grottaglie-summer2022-rainfall-fertigation-event',
  templateUrl: './grottaglie-summer2022-rainfall-fertigation-event.component.html',
  styleUrl: './grottaglie-summer2022-rainfall-fertigation-event.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieSummer2022RainfallFertigationEventComponent implements OnInit{
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
       ...
       const filteredData = dataGrottaglieAnno2Summer.filter(obj => obj !== null);
