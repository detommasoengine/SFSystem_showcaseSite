...
@Component({
  selector: 'app-grottaglie-summer2022-rains-etc-trend',
  templateUrl: './grottaglie-summer2022-rains-etc-trend.component.html',
  styleUrl: './grottaglie-summer2022-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GrottaglieSummer2022RainsEtcTrendComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        ...
        // Filtra solo i dati con valori non null per Et0 ed Etc
          const filteredData = dataGrottaglieAnno2Summer.filter(obj => obj.Cultivar !== null );
