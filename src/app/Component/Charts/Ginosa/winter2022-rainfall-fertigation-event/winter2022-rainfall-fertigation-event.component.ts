...
@Component({
  selector: 'app-ginosa-winter2022-rainfall-fertigation-event',
  templateUrl: './winter2022-rainfall-fertigation-event.component.html',
  styleUrl: './winter2022-rainfall-fertigation-event.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GinosaWinter2022RainfallFertigationEventComponent implements OnInit{
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
       ...
       const filteredData = dataGinosaAnno2Winter.filter(obj => obj !== null);
