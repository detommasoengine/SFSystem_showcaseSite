...
@Component({
  selector: 'app-ginosa-summer2021-et0-etc-trend',
  templateUrl: './summer2021-et0-etc-trend.component.html',
  styleUrls: ['./summer2021-et0-etc-trend.component.css'],
  standalone:true,
  imports:[ChartModule]
})
export class GinosaSummer2021Et0EtcTrendComponent implements OnInit{
