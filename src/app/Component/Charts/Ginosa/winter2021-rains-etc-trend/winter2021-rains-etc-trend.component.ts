...
@Component({
  selector: 'app-ginosa-winter2021-rains-etc-trend',
  templateUrl: './winter2021-rains-etc-trend.component.html',
  styleUrl: './winter2021-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
  
})
export class GinosaWinter2021RainsEtcTrendComponent implements OnInit {
