...
@Component({
  selector: 'app-ginosa-summer2021-rains-etc-trend',
  templateUrl: './summer2021-rains-etc-trend.component.html',
  styleUrls: ['./summer2021-rains-etc-trend.component.css'],
  standalone:true,
  imports:[ChartModule]
})
export class GinosaSummer2021RainsEtcTrendComponent implements OnInit {
