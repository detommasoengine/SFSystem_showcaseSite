...
@Component({
  selector: 'app-ginosa-winter2021-rainfall-fertigation-event',
  templateUrl: './winter2021-rainfall-fertigation-event.component.html',
  styleUrl: './winter2021-rainfall-fertigation-event.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GinosaWinter2021RainfallFertigationEventComponent implements OnInit{
