...
@Component({
  selector: 'app-ginosa-summer2022-rains-etc-trend',
  templateUrl: './summer2022-rains-etc-trend.component.html',
  styleUrl: './summer2022-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GinosaSummer2022RainsEtcTrendComponent implements OnInit {
