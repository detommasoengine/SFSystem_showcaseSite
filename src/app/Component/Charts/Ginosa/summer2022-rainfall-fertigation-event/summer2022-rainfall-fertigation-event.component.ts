...
import dataGinosaAnno2Summer from '../../../../Models/Ginosa/dataArrayGinosa2022Summer';
import { ChartModule } from 'primeng/chart';

@Component({
  selector: 'app-ginosa-summer2022-rainfall-fertigation-event',
  templateUrl: './summer2022-rainfall-fertigation-event.component.html',
  styleUrls: ['./summer2022-rainfall-fertigation-event.component.css'],
  standalone:true,
  imports:[ChartModule]
})
export class GinosaSummer2022RainfallFertigationEventComponent implements OnInit{
  ...
  ngOnInit() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
       ...
       const filteredData = dataGinosaAnno2Summer.filter(obj => obj.Cultivar !== null);
