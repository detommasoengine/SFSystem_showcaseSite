...
@Component({
  selector: 'app-ginosa-winter2022-rains-etc-trend',
  templateUrl: './winter2022-rains-etc-trend.component.html',
  styleUrl: './winter2022-rains-etc-trend.component.css',
  standalone:true,
  imports:[ChartModule]
})
export class GinosaWinter2022RainsEtcTrendComponent implements OnInit {
